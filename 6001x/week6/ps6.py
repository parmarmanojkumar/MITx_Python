...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        self.shift = shift
        self.encrypting_dict = self.Message.build_shift_dict(self.shift).copy()
        self.message_text_encrypted = self.Message.apply_shift(self.shift)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
#        tmpText = self.Message.get_message_text()
#        tmpText = tmpText.split(' ')
        shiftVal = None
        shiftValDict ={}
        for i in range(26):
            validCount = 0
            tmpText = self.Message.apply_shift(i).split(' ')
            for word in tmpText :
...
plaintext = PlaintextMessage('hello World LOL!', 21)
print 'Expected Output: jgnnq'
print 'Actual Output:', plaintext.get_message_text_encrypted()
    
#Example test case (CiphertextMessage)
ciphertext = CiphertextMessage('czggj Rjmgy GJG! cg')
print 'Expected Output:', (24, 'hello')
print 'Actual Output:', ciphertext.decrypt_message()

#Test
#a = Message('hello 12he@ll! 0o')
